...
docker run --name $container_name --volume ${jmeter_full_path}:/mnt/jmeter jmeter -n -Jcsv_staticParams="/mnt/jmeter/static_parameters.txt" -Jmy_csv="/mnt/jmeter/searchbody_parameters.txt" -JThreads=1 -t /mnt/jmeter/SOLR_SEARCH.jmx -l /mnt/jmeter/tmp/result_1.jtl -j /mnt/jmeter/tmp/jmeter_1.log