...
if($solrExpoExist -eq 'solrexporter') {            
	...
	docker exec -u root -i $container_name /bin/bash -c "./opt/solr-8.8.2/contrib/prometheus-exporter/bin/solr-exporter -p 8094 -z 10.10.193.107:2181 -f /opt/solr-8.8.2/contrib/prometheus-exporter/conf/solr-exporter-config_core.xml -n 16"
