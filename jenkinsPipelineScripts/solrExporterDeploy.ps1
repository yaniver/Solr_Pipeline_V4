...
$container_target_script=$container_name + ":" + $container_solr_exporter_path + "/bin/" + $script_name
...
if($solrExpoExist) {            
    Write-Host "Your string is not EMPTY, meaning solrexporter container exist"           
} else {            
