...
$solr_exporter_full_path=$solr_pipeline_home\\CICD\\SolrExporter
...
if($solrExpoExist) {            
    ...
    docker run --name solrexporter --volume $volume_path:$solrexporter_path --network=dockprom_monitor-net -d --restart always -p 8094:8094 -p 8095:8095 -p 8096:8096 solrexporter           
}